...
import uur.com.pinbook.JavaFiles.ViewModel;
...
public class DetailActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
       ...
       // setSupportActionBar((Toolbar) findViewById(R.id.toolbarxx));
    ...
    private void applyPalette(Palette palette) {
        int primaryDark = getResources().getColor(R.color.background);
        int primary = getResources().getColor(R.color.dot_light_screen3);
    ...
    private void updateBackground(FloatingActionButton fab, Palette palette) {
        ...
        int vibrantColor = palette.getVibrantColor(getResources().getColor(R.color.mapTransparentColor));
